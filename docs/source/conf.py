...
#
# pytest_pyramid documentation build configuration file, created by
...
import re
with open(os.path.join(os.path.dirname(__file__), '..', '..', 'pytest_pyramid', '__init__.py')) as v_file:
